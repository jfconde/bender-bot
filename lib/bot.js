...
module.exports = (function () {
    ...
    bot.route = (opts) => {
                    ...
                    if (currentUser) {
                        currentUser.hasPermission(opts.permissions).then(function (result) {
                            if (result) {
                                ...
                                Log.error('El usuario no tiene premisos');
                            }
                        });
                    } else {
                        Log.error('No se ha encontrado el usuario, y no tiene permisos!');
                    }
                } else {
                    module.call(this, msg, bot);
                }
        ...
        bot.on(opts.event, processRouteFn());
    };
